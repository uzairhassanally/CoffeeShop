...
namespace CoffeeShop.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderDetailId,OrderId,ItemId,Quantity,UnitPrice,Status")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderDetailId,OrderId,ItemId,Quantity,UnitPrice,Status")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
